...
- ACS market population and U.S. reference population;
- a bounded, area-equivalent provider-search radius;
- source GEOID and dataset version.

The checked-in `us-geography-2024.1` database contains more than 31,000 populated Census
...
- 2024 ACS five-year table B01003 for population;
